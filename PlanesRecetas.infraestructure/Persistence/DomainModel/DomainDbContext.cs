    ...
    public class DomainDbContext : DbContext, IDatabase
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Nutricionista>().HasData(
                new { Id = Guid.Parse("4224DE05-C1B1-424D-4D22-08DE14A4DB50"), Nombre = "Daniel Román", Activo = false, FechaCreacion = new DateTime(2024, 1, 1,0,0,0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("4CE7D823-87F3-4181-B936-08DE14A787B0"), Nombre = "Ricardo Mena", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 15, 51, 11, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("7A918AFC-94BB-46D7-7155-08DE1746E629"), Nombre = "Jorge Parra", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 23, 57, 10, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("A0C733F5-3F18-4176-114E-08DE181E81FB"), Nombre = "Carlos Javier", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 01, 40, 34, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("D1F1DEA7-5596-4399-DAF3-08DE350D21EE"), Nombre = "Enzo Fernández", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 21, 19, 05, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("87BA4A90-3EFA-4D27-8692-0BFD86DAF6BD"), Nombre = "Valeria Gómez", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 03, 25, 15, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("6C54B71F-4A1B-47C1-ACA4-0CECA607D5EB"), Nombre = "Andrés Castro", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 21, 47, 20, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("1C2F7051-D0E9-454D-8653-19542C7AA5BF"), Nombre = "Mariana Ríos", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 02, 53, 19, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("5A2FE591-701B-4324-ACFE-252DE1EFDD9D"), Nombre = "Lucía Méndez", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 02, 24, 43, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("46D0DFDF-5687-4042-88BA-37E7B2EBBE0B"), Nombre = "Sergio Torres", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 14, 55, 08, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("3237E879-17CD-4F03-A625-41A572DB6BE7"), Nombre = "Beatriz Luna", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 21, 45, 21, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("090B93FF-E07C-4187-BFC9-54493B6CDFBF"), Nombre = "Fernando Soto", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 21, 36, 53, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("54F96058-C83F-4681-8D30-65A53CF86BD2"), Nombre = "Karla Espinoza", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 21, 37, 52, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("8163C819-2F48-47CD-AA47-7BC4C7FF5D98"), Nombre = "Chef Ranci", Activo = true, FechaCreacion = new DateTime(2024, 1, 1,0, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("D3B13C4A-67FA-4FCE-B915-83EB26E1C939"), Nombre = "Chef Ranci Professional", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 18, 20, 54, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("185132BE-5513-4653-B8B6-93625438D04E"), Nombre = "Paola Argüello", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 15, 42, 05, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("40278D23-3911-48D5-9E6D-9B26DC61E93B"), Nombre = "Roberto Villalba", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 15, 00, 41, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("B608BCCE-4290-4789-81E9-CDFA957402BB"), Nombre = "María Delgado", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 16, 09, 12, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("12BF19A5-B30C-49EE-B75C-D9E8769FB05F"), Nombre = "Luigi Vampa", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 16, 05, 51, 0, 0, DateTimeKind.Utc) },
                new { Id = Guid.Parse("AB971254-D489-452A-B809-F3D29D7CEB88"), Nombre = "Elena Martínez", Activo = true, FechaCreacion = new DateTime(2024, 1, 1, 02, 53, 19, 0, 0, DateTimeKind.Utc) }
            );
            modelBuilder.Entity<Paciente>().HasData(
                new { Id = Guid.Parse("DE44922E-B41A-46A3-0245-08DE14C94AA7"), Nombre = "Ariana", Apellido = "Grande", FechaNacimiento = new DateTime(2000, 10, 26, 0, 0, 0, DateTimeKind.Utc), Peso = 76m, Altura = 167m },
                new { Id = Guid.Parse("D2740F5A-ABE1-4A0B-A300-08DE1746D733"), Nombre = "Pedro", Apellido = "Chavez", FechaNacimiento = new DateTime(2019, 10, 29, 0, 0, 0, DateTimeKind.Utc), Peso = 110m, Altura = 180m },
                new { Id = Guid.Parse("9F972A0E-3153-4B9B-98CC-08DE181E9EFC"), Nombre = "Juan", Apellido = "Carlos Duran", FechaNacimiento = new DateTime(2005, 10, 31, 0, 0, 0, DateTimeKind.Utc), Peso = 110m, Altura = 170m },
                new { Id = Guid.Parse("7CD40A9B-5BF2-4DBF-B9EE-0C1093B306C0"), Nombre = "Ricardo", Apellido = "Sosa", FechaNacimiento = new DateTime(2026, 3, 6, 0, 0, 0, DateTimeKind.Utc), Peso = 3.5m, Altura = 50m },
                new { Id = Guid.Parse("7F1C4C1E-5A54-4C4C-9E15-0C6C1B8D4D55"), Nombre = "Maria", Apellido = "Elena", FechaNacimiento = new DateTime(1985, 11, 22, 0, 0, 0, DateTimeKind.Utc), Peso = 65m, Altura = 160m },
                new { Id = Guid.Parse("9D1E822C-FFB9-4009-B16E-0F4259B2FA1A"), Nombre = "Juan", Apellido = "Perez", FechaNacimiento = new DateTime(2026, 1, 19, 0, 0, 0, DateTimeKind.Utc), Peso = 50m, Altura = 70m },
                new { Id = Guid.Parse("12B9C6E2-34D7-4FB2-B5D1-119773A6834F"), Nombre = "Roberto", Apellido = "Guzman", FechaNacimiento = new DateTime(2026, 2, 19, 0, 0, 0, DateTimeKind.Utc), Peso = 4.2m, Altura = 52m },
                new { Id = Guid.Parse("E4B8E3D5-63F3-482F-979A-1256427B09E1"), Nombre = "Chris", Apellido = "Walker", FechaNacimiento = new DateTime(1987, 06, 18, 0, 0, 0, DateTimeKind.Utc), Peso = 74m, Altura = 185m },
                new { Id = Guid.Parse("C06A5A28-4B9A-4812-BB37-1658BFB58B7E"), Nombre = "Layne", Apellido = "Fahey", FechaNacimiento = new DateTime(1979, 02, 13, 0, 0, 0, DateTimeKind.Utc), Peso = 103m, Altura = 207m },
                new { Id = Guid.Parse("8FE998C5-BF70-49F9-BA34-17149B9AEF8D"), Nombre = "Esteban", Apellido = "Quito", FechaNacimiento = new DateTime(2026, 01, 20, 0, 0, 0, DateTimeKind.Utc), Peso = 100m, Altura = 160m },
                new { Id = Guid.Parse("1183D1B1-6C9A-4264-AFE1-28B020225B39"), Nombre = "Juan", Apellido = "Calisalla", FechaNacimiento = new DateTime(2026, 02, 28, 0, 0, 0, DateTimeKind.Utc), Peso = 70m, Altura = 175m },
                new { Id = Guid.Parse("90EECB08-DA56-48B3-917D-2F80F55701F5"), Nombre = "Monica", Apellido = "Suarez", FechaNacimiento = new DateTime(2026, 03, 06, 0, 0, 0, DateTimeKind.Utc), Peso = 58m, Altura = 162m },
                new { Id = Guid.Parse("A2B10DB8-AAD2-4F62-81FF-309B24B53402"), Nombre = "Layne", Apellido = "Fahey", FechaNacimiento = new DateTime(1979, 02, 13, 0, 0, 0, DateTimeKind.Utc), Peso = 103m, Altura = 207m },
                new { Id = Guid.Parse("41234E45-8FD3-4992-A7FF-3330FFEA60AD"), Nombre = "Davos", Apellido = "Villarruel", FechaNacimiento = new DateTime(2026, 03, 05, 0, 0, 0, DateTimeKind.Utc), Peso = 10m, Altura = 10m },
                new { Id = Guid.Parse("1C6BBD23-A625-4439-BB7C-34E52B7AE2C2"), Nombre = "Gino", Apellido = "Spinka", FechaNacimiento = new DateTime(1957, 11, 09, 0, 0, 0, DateTimeKind.Utc), Peso = 108m, Altura = 201m }
            );
